...
<div class="row">
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                @foreach ($categories as $category)
                    <a href="{{ route('category', ['id' => $category->id]) }}"> <button class="dropdown-item"
                            type="button">{{ $category->name }}</button></a>
                @endforeach
    ...
    <div class="col-md-4">
        <input type="text" placeholder="search...." class="form-control input-md" wire:model="term">
    </div>
</div>
